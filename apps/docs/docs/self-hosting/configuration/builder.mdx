...
| ENCRYPTION_SECRET <Asterix/>      |         | A 256-bit key used to encrypt sensitive data. It is strongly recommended to generate a new one. The secret should have 32 characters lenght and should be the same between builder and viewer. |
